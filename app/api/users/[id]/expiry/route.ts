...
export async function GET(
  ...
  try {
    ...
    usersLogger.error('Error fetching user expiry', { userId: id, error: error instanceof Error ? error.message : String(error) });
...
export async function PUT(
  ...
  try {
    ...
    usersLogger.error('Error updating user expiry', { userId: id, error: error instanceof Error ? error.message : String(error) });
